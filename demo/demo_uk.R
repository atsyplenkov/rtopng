# demo_uk.R
# Universal-kriging MAF baseline using automap and altitude as a covariate.
#
...
# - ch01 describes universal kriging in automap as z ~ covariates.
# - ch06 motivates altitude/elevation as an external drift when deterministic
#   gradients explain broad spatial structure before kriging residuals.
#
...
# The ungauged catchment layer has no altitude field. For this standalone demo,
